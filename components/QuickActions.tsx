...
export default function QuickActions() {
  ...
  return (
    <div className="w-64 bg-gray-800 min-h-screen p-4 border-r border-gray-700">
      <h2 className="text-white text-lg font-semibold mb-4 px-3">Quick Actions</h2>
          ...
          if ('external' in action && action.external) {
            return (
              <a
                ...
                className="flex items-center space-x-3 px-3 py-2 rounded-lg transition text-gray-300 hover:bg-gray-700 hover:text-white"
              >
                {action.icon}
